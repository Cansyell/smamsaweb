...
<div class="max-w-7xl mx-auto">
    ...
    <div class="mb-6 flex justify-between items-center">
        <div>
            ...
            <p class="text-sm text-gray-600 mt-1">Kelola data tahun ajaran akademik</p>
        </div>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @forelse($academicYears as $year)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900">{{ $year->name ?? '-' }}</div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900">
                                    {{ optional($year->specializationQuotas)->count() ?? 0 }} Quota
                                </div>
                            </td>
                                ...
                                <div class="flex justify-end gap-2">
                                    ...
                                    <form action="{{ route('admin.academic-years.destroy', $year) }}" 
                                        ...
                                        <button type="submit"
                                            ...
                                            title="Hapus"
                                            @if($year->is_active || ($year->specializationQuotas?->count() ?? 0) > 0) disabled @endif
                                        >
                                    </form>
                                </div>
                            </td>
