    ...
    <nav class="mt-6">
        @if(auth()->user()->role === 'admin')
            ...
            <a href="{{ route('admin.report-grades.index') }}"
               class="flex items-center px-6 py-3 text-gray-300 hover:bg-gray-700 hover:text-white transition {{ request()->routeIs('admin.report-grades.*') ? 'bg-gray-700 text-white' : '' }}">
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {{-- FIX: route check changed from 'admin.users.*' to 'admin.welcome.*' --}}
            <a href="{{ route('admin.welcome.setting') }}"
               class="flex items-center px-6 py-3 text-gray-300 hover:bg-gray-700 hover:text-white transition {{ request()->routeIs('admin.welcome.*') ? 'bg-gray-700 text-white' : '' }}">
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        @elseif(auth()->user()->role === 'committee')
            ...
            {{-- FIX: route check changed from 'committee.saw-results.*' to correct unique routes --}}
            ...
            <a href="{{ route('committee.selection-results.index') }}"
               class="flex items-center px-6 py-3 text-gray-300 hover:bg-gray-700 hover:text-white transition {{ request()->routeIs('committee.selection-results.*') ? 'bg-gray-700 text-white' : '' }}">
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
