...
class CommitteeStudentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('committee.students.index', compact('students', 'academicYears', 'selectedYearId'));
    }
    ...
    {
        return view('committee.students.create');
    }
    ...
    {
        $student->load('user');
        return view('committee.students.show', compact('student'));
    }
    ...
    {
        return view('committee.students.edit', compact('student'));
    }
    ...
    public function pending(Request $request)
    {
        ...
        return view('committee.students.pending', compact('students'));
    }
