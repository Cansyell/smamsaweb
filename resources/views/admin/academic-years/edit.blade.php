...
<div class="max-w-4xl mx-auto">
    ...
    <div class="mb-6">
        <div class="flex items-center gap-3 mb-2">
            ...
            <div>
                <h2 class="text-2xl font-bold text-gray-800">Edit Tahun Ajaran</h2>
                <p class="text-sm text-gray-600 mt-1">Perbarui data tahun ajaran {{ $academicYear->year }}</p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-md">
        <form action="{{ route('admin.academic-years.update', $academicYear) }}" method="POST" class="p-6">
            @csrf
            @method('PUT')
            ...
            <div class="mb-6">
                ...
                <textarea name="description" 
                    ...
                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 @error('description') border-red-500 @enderror">{{ old('description', $academicYear->description) }}</textarea>
                @error('description')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
                ...
                <div class="flex gap-3">
                    ...
                    <div class="text-sm text-blue-800">
                        ...
                        <ul class="list-disc list-inside space-y-1 text-blue-700">
                            <li>Total Siswa: {{ $academicYear->student_count }} siswa</li>
                            <li>Total Quota: {{ $academicYear->specializationQuotas->count() }} quota</li>
                            <li>Durasi: {{ $academicYear->duration_in_days }} hari</li>
                        </ul>
                    </div>
                </div>
            </div>
